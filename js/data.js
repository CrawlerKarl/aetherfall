...
const PATHS = {
  ...
  bond: { name: 'BOND', role: 'PICKUPS & SCORE', family: 'utility', color: '#ec407a',
    ...
    { key: 'bond',      icon: 'pokeball', name: "KEEPER'S PACT", desc: 'EACH CATCH: PERMANENT +6% SCORE',
    ...
    { key: 'revive',    icon: 'heart',    name: 'AETHER REVIVE',    desc: '+1 LIFE NOW · +1 LIFE EVERY REGION CLEARED',
