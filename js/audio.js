...
const ADVENTURE_MUSIC = Object.freeze([
  { region: 'MARCHES', title: 'TRAILHEAD SKIES', root: 60, bpm: 126, scale: [0,2,4,5,7,9,11], prog: [0,3,4,0],
  ...
  { region: 'REACHES', title: 'BELLFLOWER ROAD', root: 62, bpm: 112, scale: [0,2,4,7,9], prog: [0,3,1,4],
  ...
  { region: 'DROWNED COAST', title: 'TIDELINE EXPEDITION', root: 63, bpm: 132, scale: [0,2,4,5,7,9,10], prog: [0,4,3,5],
  ...
  { region: 'FORGEHEART', title: 'MOUNTAIN LANTERNS', root: 65, bpm: 118, scale: [0,2,3,5,7,9,10], prog: [0,3,6,4],
  ...
  { region: 'NEON DOMINION', title: 'SKYLINE EXPRESS', root: 67, bpm: 138, scale: [0,2,4,6,7,9,11], prog: [0,4,1,5],
  ...
  { region: 'GLASS COURTS', title: 'CITYGLASS PROMENADE', root: 68, bpm: 120, scale: [0,2,4,5,7,9,11], prog: [0,5,3,4],
  ...
  { region: 'LEY ATOLLS', title: 'ISLAND WINDWAY', root: 70, bpm: 128, scale: [0,2,4,7,9,10], prog: [0,3,4,1],
  ...
  { region: 'WAR CRADLE', title: 'CROWN MARCH', root: 61, bpm: 134, scale: [0,2,4,5,7,9,10], prog: [0,4,5,3],
  ...
  { region: 'SUNDERED CRADLE', title: 'TREASURE ROAD', root: 64, bpm: 142, scale: [0,1,4,5,7,8,10], prog: [0,3,4,1],
