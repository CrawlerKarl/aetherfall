...
const SCENE_SKIES = [
  [ { sky: ['#9fc4e8', '#ffd0a0', '#ffe9c0'], cel: 'sunrise', dark: 0 },
  ...
  [ { sky: ['#bcd8ef', '#dce9f4', '#f0f6fa'], cel: 'noon', dark: 0 },
